...
In 2024, Quelle syntax was refined and updated. Version 4 retains most of the search syntax introduced in version 1. Updates to the specification are related to macros, settings, filters, and export directives. Search syntax is mostly unchanged. The update has introduced new operators [We added # $ % and || to name a few] . These new operators have eliminated all clause delimiters. Version 4 syntax is more streamlined and more intuitive. It comes with a reference implementation in Rust and a fully specified PEG grammar. 
