...
S4T has only one control statement. This is described more completely in Section 3.
...
While technically not an S4T command, program help is available using the pull-down menu on the right of the AV-Bible application.
